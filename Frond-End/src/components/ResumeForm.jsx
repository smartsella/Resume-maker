    ...
    <form onSubmit={handleSubmit} className="p-4 bg-gray-100 rounded">
      ...
      <div className="mb-4">
        ...
        <button
          type="button"
          onClick={addSkill}
          className="bg-blue-300 text-black px-2 py-1 text-sm rounded"
        >
          Add Skill
        </button>
      </div>
        ...
        {formData.education.map((edu, idx) => (
          <div key={idx} className="mb-2 p-2 border bg-white">
            <input
              ...
              onChange={(e) => handleChange("education", e, idx, "institution")}
              className="mr-2 border p-1"
            />
            <input
              placeholder="Degree"
              value={edu.degree}
              onChange={(e) => handleChange("education", e, idx, "degree")}
